...
bGesture.addDirection(Finger.Thumb, FingerDirection.VerticalUp, 1.0);
...
for(let finger of [Finger.Index, Finger.Middle, Finger.Ring, Finger.Pinky]) {
    ...
    bGesture.addDirection(finger, FingerDirection.DiagonalUpLeft, 0.5);
    bGesture.addDirection(finger, FingerDirection.DiagonalUpRight, 0.5);
}